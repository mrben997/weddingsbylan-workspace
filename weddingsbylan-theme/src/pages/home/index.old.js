...
const projectManager = {
  ...
  initVerticalSwiper: () => {
    try {
      return new Swiper('.vertical-swiper', {
        ...
        on: {
          init: function () {
            projectManager.preloadParallaxMinor(this)
            projectManager.updateParallax(this)
            projectManager.updateLogoClass(this)
          },
          ...
          slideChangeTransitionEnd: function () {
            projectManager.updateParallax(this)
            projectManager.restoreParallaxMinor(this)
          }
        }
      })
    } catch (error) {
      ...
      const swiper = new Swiper('.horizontal-carousel', {
        ...
        on: {
          init: function () {
            ...
            setTimeout(() => {
              projectManager.updateNavigationNumbers(this)
            }, 100)
          },
  ...
  initial: () => {
    projectManager.initVerticalSwiper()
    projectManager.initHorizontalSwiper()
    projectManager.menuInitialize()
  }
}
