...
export const TextCkEditor: FC<ITextCkEditorProps<ClassicEditor>> = (props) => {
    ...
    const Content = useMemo(() => <div className="main-container" >
        <input name={props.name} value={content} hidden />
    ...
    </div>, [isLayoutReady, content])
    return (
        isFullscreen ? ReactDOM.createPortal(
            <div className='full-screen-mode' style={{
                position: 'absolute', top: 0, left: 0, zIndex: 2000, width: '100vw', height: '100vh',
                display: 'flex',
                ...
                <div style={{ maxWidth: '1000px', flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'flex-end', flexDirection: 'column' }}>
                        <button className='full-screen' onClick={onFullscreen}><i className="material-icons">fullscreen</i></button>
                    </div>
                    {Content}
                </div>
            </div>, document.body) :
