  ...
  return (
    <ResponsiveDrawerContext.Provider value={{ openMobile }}>
      <Box sx={{ display: 'flex' }}>
        ...
        <Box component='nav' sx={{ width: drawerMode ? {} : { md: drawerWidth }, flexShrink: { sm: 0 } }} aria-label='mailbox folders'>
...
export const OpenMobileMenu = () => {
  return <ResponsiveDrawerContext.Consumer>{(context) => <ProcessContextMenu context={context} />}</ResponsiveDrawerContext.Consumer>
}
