...
const PropsContext = CreatePropsContext<TNewsProps>()

const Table = CreateTableTemplate<INews>("Client", {
...
class NewsPage extends Component<TNewsProps, INewsPageState> {
