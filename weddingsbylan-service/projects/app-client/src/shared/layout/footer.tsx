...
//               <a className='typography-h6' href='/app'>
//                 Home
//               </a>
//             </li>
//             <li className='footer-nav-item'>
//               <a className='typography-h6' href='/app/photography'>
//                 Photography
//               </a>
//             </li>
//             <li className='footer-nav-item'>
//               <a className='typography-h6' href='/app/makeup-and-hair'>
//                 Makeup &amp; Hair
//               </a>
//             </li>
//             <li className='footer-nav-item'>
//               <a className='typography-h6' href='/app/portfolio'>
//                 Portfolio
//               </a>
//             </li>
//             <li className='footer-nav-item'>
//               <a className='typography-h6' href='/app/contact-us'>
//                 Contacts Us
//               </a>
//             </li>
//           </ul>
